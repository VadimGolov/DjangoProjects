...
**4. Небольшая подсистема Unit-тестов**
...
**3. Работа с базой данных**
  ...
  Таблица Flower является моделью для хранения информации о цветах. Она содержит название, цену, путь к фото и идентификатор фото (Telegram).
